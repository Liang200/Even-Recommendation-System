...
public class MongoDBTableCreation {
  ...
  public static void main(String[] args) throws ParseException {
		...
		IndexOptions options = new IndexOptions().unique(true);// create a object increat search speed and the index is required to be unique
		...
		db.getCollection("users").insertOne(
				new Document().append("user_id", "MTOASF").append("password", "d09a6279ffead6f5a351b4bb7f4e454b")
						.append("first_name", "LIANG").append("last_name", "MENG"));
		mongoClient.close();
